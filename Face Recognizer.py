        ...
        if ret:
            ...
            if len(faces) != 0:
                for face in faces:
                    ...
                    frame = draw_rectangle(frame, (left, top), (right, bottom), frame_rect_color, False)
                    frame = draw_rectangle(frame, (left, top - 30), (right, top), frame_rect_color, True)
                    frame = write_text(frame, person_name, (left + 6, top - 6), frame_text_color)
